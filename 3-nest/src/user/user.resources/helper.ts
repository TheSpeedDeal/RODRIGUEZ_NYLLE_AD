...
export class Helper {
  ...
  static populate(): Map<string, User> {
    ...
    try {
      var users = [
        new User('Leanne Graham', 18, 'sincere@april.biz', 'LG_123456', 76000),
        new User('Ervin Howell', 21, 'shanna@melissa.tv', 'EH_123123', 5000),
        new User('Nathan Plains', 25, 'nathan@yesenia.net', 'NP_812415', 10000),
        new User('Patricia Lebsack', 18, 'patty@kory.org', 'PL_12345', 250000),
      ];
      users.forEach((user) => {
  ...
  static validBody(body: any): { valid: boolean; data: string } {
    ...
    var keys: Array<string> = ['name', 'age', 'email', 'password', 'balance'];
